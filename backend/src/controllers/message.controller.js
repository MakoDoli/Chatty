...
export const getUsersForSidebar = async (req, res) => {
  try {
    const loggedInUsrId = req.user._id; // we have req.user because of middleware function protectRoute which attaches "user" object to request

    const filteredUsers = await User.find({
      _id: { $ne: loggedInUsrId },
    }).select("-password");
